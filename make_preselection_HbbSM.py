...
if __name__ == "__main__":
    ...
    #############################
    if jobs!=1:
        f = TFile( "/afs/cern.ch/work/m/mrogulji/Zbb/templates/HbbSM"+options.year+"_"+options.set+"_job"+options.job+"of"+options.njobs+mod+'_'+doubleB_short+'_'+options.region+".root", "recreate" )
    else:
        f = TFile( "/afs/cern.ch/work/m/mrogulji/Zbb/templates/HbbSM"+options.year+"_"+options.set+mod+'_'+doubleB_short+'_'+options.region+".root", "recreate" )
    f.cd()
